...
if($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configselect('block_sms_api','SMS API Name', 'Select Api which you are using', 'LabsMobile', array('Clickatell','Sendsms.pk','Yuboto','LabsMobile')));
}